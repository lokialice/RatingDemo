...
class GamePickerTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        games = ["Angry Birds","Chess","Russian Roulette","Spin the Bottle","Texas Hold Poker","Tic-tac-toe"]
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        //Other row is selected - need  to deseclect it
        ...
        //update check mark for the current row
